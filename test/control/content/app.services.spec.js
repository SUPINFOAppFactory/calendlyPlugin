describe('Unit: calendlyPluginContent: Services', function () {
    beforeEach(module('calendlyPluginContent'));
  ...
  describe('Unit : DataStore Factory', function () {
    ...
    beforeEach(module('calendlyPluginContent', function ($provide) {
    ...
    beforeEach(module('calendlyPluginContent'));
    beforeEach(inject(function (_DataStore_, _STATUS_CODE_, _STATUS_MESSAGES_, _TAG_NAMES_, _$rootScope_, _Utils_) {
  ...
  it('DataStore.save should exist and be a function', function () {
    ...
    it('DataStore.get should return success', function () {
      ...
      DataStore.get(TAG_NAMES.CALENDLY_INFO).then(success, error);
      $rootScope.$digest();
    ...
    it('DataStore.update should return success', function () {
      ...
      DataStore.update( 123, TAG_NAMES.CALENDLY_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
    ...
    it('DataStore.save should return success', function () {
      ...
      DataStore.save( 123, TAG_NAMES.CALENDLY_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
  })
